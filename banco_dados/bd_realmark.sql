...
insert into `realmark`.`lojas` values 
(null, 'Magazine Luiza');
...
insert into `realmark`.`marcas` values 
(null, 'Acer'),
(null, 'Samsung'),
(null, 'Lg'),
(null, 'Sony'),
...
insert into `realmark`.`categorias` values 
(null, 'Todos');
...
insert into `realmark`.`nichos` values 
...
insert into `realmark`.`tipos` values 
(null, 'TV', 'tv'),
